...
export const codingContinuation: ContinuationModule[] = [
  ...
  { id: "continuation-week-3-retrieval", week: 3, title: "Applied AI engineering", outcome: "Build a permission-aware, source-grounded assistant with evaluation rather than unbounded chat behavior.", activities: ["Explain embeddings, chunking, metadata, and citations as separate concerns.", "Create a fictional approved document set and evaluation cases.", "Compare structured extraction or retrieval behavior across supported and unsupported prompts.", "Add prompt-injection, stale-source, and human-escalation cases."], artifact: "Procedure and maintenance document assistant design with evaluation set, citations, and a human-review boundary.", defense: "Why is a cited answer still not automatically trustworthy, and what evidence would change the design?", competencyWeights: { aiApplications: 1, securityReliability: .9, testingDebugging: .8, architecture: .7, defense: .8 }, sourceIds: ["nistAiRmf", "owaspGenAi", "openaiStructured"] },
  { id: "continuation-week-4-team", week: 4, title: "Team delivery and interview readiness", outcome: "Package technical work so another engineer can review, run, challenge, and improve it.", activities: ["Create a branch, focused pull request, and review checklist.", "Resolve a fictional merge conflict and explain the chosen behavior.", "Write an architecture diagram, README, deployment assumptions, and risk register.", "Run a mock system-design and behavioral interview with a changing requirement."], artifact: "Operational AI Assistant portfolio package: typed API, persistence, evaluation, tests, secure configuration plan, human-review workflow, and technical defense.", defense: "What would another engineer need to run this, what would security challenge, and what is your next production decision?", competencyWeights: { git: 1, defense: 1, architecture: .9, securityReliability: .8 }, sourceIds: ["githubPr", "nistSsdf", "nistAiRmf"] },
];
