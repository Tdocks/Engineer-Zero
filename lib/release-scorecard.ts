  ...
  const programs = [
    ...
    },
    {
      ...
      signals: [
        ...
        signal("simulation-authenticity", itSupportLabs.length >= 12 && itSupportMissions.length >= 6 ? "strong" : "partial", itSupportLabs.length >= 12 && itSupportMissions.length >= 6 ? "Twelve authored labs and six stateful missions cover the IT Support launch simulation catalog across endpoint, network, identity, printing, AV, asset, and pressure-communication scenarios." : "IT Support simulation catalog is below the 12-lab / 6-mission launch target.", "Human scenario review of branch consequences and debriefs before marketing Master Track completeness."),
