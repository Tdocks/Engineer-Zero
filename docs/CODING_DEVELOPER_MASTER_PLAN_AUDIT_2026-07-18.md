...
| Four days of instruction and capstones | 24 authored lessons, six challenges, four runnable starter projects, a Day 2 FastAPI service with `/health`, `/triage`, and `/rules`, and a Day 4 handoff capstone | Implemented for local pilot. |
