...
| Four days of instruction and capstones | 24 authored lessons, six challenges, four runnable starter projects, a Day 2 FastAPI service with `/health`, `/triage`, and `/rules`, a Day 3 prototype with covered configuration/schema/unit/input/injection failure cases, and a Day 4 handoff capstone | Implemented for local pilot. |
